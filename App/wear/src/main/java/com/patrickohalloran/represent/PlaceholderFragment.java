...
//        System.out.println(memInfo.length);
//        args.putInt(ROW, row);
//        args.putInt(COL, col);
...
//        }
        ...
        //Set the name and party
        TextView nameView = (TextView) view.findViewById(R.id.congress_member_name);
        nameView.setText(mArgs[0] + " " + mArgs[1] + System.lineSeparator() + mArgs[2]);
    ...
    public void finishClick(View v) {
        ...
        String lastName = mArgs[0];
        String party = mArgs[0];
        String bioguide = mArgs[0];
        String termEnd = mArgs[0];
        String title = mArgs[0];

        String[] memberInfo = {firstName, lastName, party, bioguide, termEnd, title};
